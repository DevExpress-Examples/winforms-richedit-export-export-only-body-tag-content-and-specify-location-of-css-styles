...
'#End Region
        ...
        Private btnLoadDocument As DevExpress.XtraEditors.SimpleButton

        Private edtCssStyleType As DevExpress.XtraEditors.ComboBoxEdit

        Private labelControl1 As DevExpress.XtraEditors.LabelControl

        Private labelControl2 As DevExpress.XtraEditors.LabelControl

        Private edtExportHtmlType As DevExpress.XtraEditors.ComboBoxEdit

        Private btnExportHtml As DevExpress.XtraEditors.SimpleButton
